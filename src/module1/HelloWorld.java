...
public class HelloWorld extends PApplet
{
	...
	public void setup() {
		...
		AbstractMapProvider providerHometown = new Microsoft.HybridProvider();
		
		map2 = new UnfoldingMap(this, 410, 50, 350, 500, providerHometown);
		map2.zoomAndPanTo(zoomLevel, new Location(50.84f, 4.35f));
